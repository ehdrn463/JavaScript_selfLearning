...
var average_john = (89+120+103) / 3;
var average_mike = (116+94+123) / 3;
var average_mary = (97+134+105) / 3;

if (average_john > average_mike){
    console.log('Winner is John' + average_john);
} else if ( average_john == average_mike){
    console.log("Winner is none" + average_john + '=' + average_mike);
} else{
    console.log("Winner is Mike" + average_mike);
}
